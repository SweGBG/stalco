      ...
      <nav className={styles.nav}>
        <div className={styles.navTop}>
          ...
          <div className={styles.navIcons}>
            <button className={styles.navIcon} onClick={() => setCartCount(c => c)}>
            ...
            <div className={styles.langSwitch}>
              <button className={`${styles.langBtn} ${lang === "sv" ? styles.langActive : ""}`} onClick={() => setLang("sv")} aria-label="Svenska">🇸🇪</button>
              <button className={`${styles.langBtn} ${lang === "en" ? styles.langActive : ""}`} onClick={() => setLang("en")} aria-label="English">🇬🇧</button>
            </div>
