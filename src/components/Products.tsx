...
const products = [
  ...
  { id:2, name:"Milwaukee M18 FMTIW2", catIdx:1, brand:"Milwaukee", spec:"18V FUEL · 1000 Nm", price:3890, oldPrice:4490, discount:13, img:"https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=500&q=80&fit=crop", stock:true, hot:true },
          ...
          <div key={p.id} className={styles.card}>
            ...
            <div className={styles.body}>
              ...
              <div className={styles.footer}>
                ...
                <button className={`${styles.addBtn} ${!p.stock ? styles.addBtnDisabled : ""}`} disabled={!p.stock} onClick={() => p.stock && (window as any).__stalco_addToCart?.()}>
